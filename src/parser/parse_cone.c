...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/24 13:05:43 by nluchini          #+#    #+#             */
/*   Updated: 2025/12/24 13:05:44 by nluchini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	parse_cone_bonus_fields(char **tokens, t_cone *cone)
{
	t_rgb	color;
	t_vec3	center;
	t_vec3	axis;
...
int	parse_cone_bonus(char **tokens, t_scene *scene)
{
	...
	if (!parse_cone_bonus_fields(tokens, cone))
