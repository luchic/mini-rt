...
/*   Updated: 2025/10/17 14:39:15 by yyudi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	hit_cylinder(t_cylinder *cy, t_ray ray_in, float tmax, float *t_hit_out, t_vec3 *normal_out, t_material *mat_out)
{
	t_vec3  axis = cy->a;
	t_vec3  oc = vsub(ray_in.o, cy->c);
